                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{url('frontend/img/slider/Woo_Package_New_Bnr1.png')}}" class="d-block w-100 rounded" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{url('frontend/img/}slider/Woo_Package_New_Bnr2.png')}}" class="d-block w-100 rounded" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 my-3">
                    <div class="blg-wrap bg-white pb-3">
                        <figure class="position-relative">
                            <img src="{{url('frontend/img/blog/podcast.jpg')}}" alt="" class="w-100">
                            <figcaption class="position-absolute w-100 h-100"><span class="blg-dt">4 مرداد</span></figcaption>
                        </figure class="position-relative">
                        <div class="px-3 py-1 text-start">
